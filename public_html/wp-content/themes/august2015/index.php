...
<div class="header-banner">
    <div class="container text-center">
        <h2 class="text-bold">Welcome Evolable Asia</h2>
        <h2>Our mission</h2>
        <h3>To be No.1 providing IT software development support in Asia</h3>
    </div>
</div>
<div class="header-join">
    <div class="container text-center">
        <h2 class="text-bold">We are waiting for you. Joining us now!</h2>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <img class="img-responsive" src="<?php echo get_template_directory_uri() ?>/img/2.png" alt="">
            </div>
            <div class="col-xs-12 col-md-6">
                <div class="row">
                    <div class="col-xs-12">
                        <p>
                            Lorem 07/2011: Dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        ...
        <div class="row">
            <div class="col-xs-12 col-md-4">
                <div class="row">
                    ...
                    <div class="col-xs-9">
                        <div class="h4">Web service, smart phone app development</div>
                        <p>Tháng 3-2012: Thành lập văn phòng đầu tiên tại khu chế xuất Tân Thuận quận 7</p>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-md-4">
                <div class="row">
                    <div class="col-xs-3">
                        <img src="<?php echo get_template_directory_uri() ?>/img/4.png" alt="" class="img-responsive">
                    </div>
                    <div class="col-xs-9">
                        <h4>BPO</h4>
                        <p>Tháng 3-2012: Thành lập văn phòng đầu tiên tại khu chế xuất Tân Thuận quận 7</p>
            ...
            <div class="col-xs-12 col-md-4">
                <div class="row">
                    <div class="col-xs-3">
                        <img src="<?php echo get_template_directory_uri() ?>/img/5.png" alt="" class="img-responsive">
                    </div>
                    <div class="col-xs-9">
