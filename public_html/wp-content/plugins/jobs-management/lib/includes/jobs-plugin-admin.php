...
//        $page = add_options_page(__('Plugin Settings', 'plugin_textdomain'), __('Plugin Settings zzz', 'plugin_textdomain'), 'manage_options', 'plugin_settings', array($this, 'settings_page'));
        $page = add_submenu_page('edit.php?post_type=job', __('Plugin Settings', 'plugin_textdomain'), __('Plugin Settings zzz', 'plugin_textdomain'), 'manage_options', 'plugin_settings', array($this, 'settings_page'));
