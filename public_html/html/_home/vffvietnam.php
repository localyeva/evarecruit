<section id="vffvientnam">
  ...
  <div class="container">
    ...
    <div class="row">
      <img src="img/vff/5.png" class="img-responsive center-block " alt="Responsive Image"/>
    </div>
    <div class="row voffset1"></div>
    <div class="row voffset1"></div>

    <div class="row">
      <img src="img/vff/2.png" class="img-responsive center-block " alt="Responsive Image"/>
    </div>
    <div class="row voffset1"></div>
    <div class="row voffset1"></div>
      ...
      <!-- dòng đầu tiên -->
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-xs-12">
              ...
              <img src="img/vff/6.png" class="text-colorimg" alt="Responsive Image"/>
      ...
      <!-- dòng thứ 2 -->
        ...
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <img src="img/vff/7.png" class="text-colorimg" />
        ...
        <div class="text-left">
          ...
          <div class="row">
            <div class="col-md-2"></div>
            <div class="col-md-8">
              <p>Điều này có nghĩa là kết quả nỗ lực của từng người đã giúp chúng ta trở nên có sức để trưởng thành trong việc làm đại biểu Việt Nam.</p>
            </div>
            <div class="col-md-2"></div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <img src="img/vff/8.png" class="text-colorimg" />
              <h3 class="text-color"> <b> Tuyên ngôn quản lý</b></h3>
